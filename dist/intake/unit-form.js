...
export default function UnitForm({ action, fields, mode, cancelHref, duplicateHref, initial = {}, fieldOptions, pickerColumns = [], renderPicker, submitLabel, }) {
